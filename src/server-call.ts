...
export const serveServerCall = <DefaultServerCallResponse>({ defaultResponseDataDept, server, successFieldDept, logger, handleServerError, defaultAuthSource }: ServeServerCall) => async <ServerCallResponse = DefaultServerCallResponse>(
